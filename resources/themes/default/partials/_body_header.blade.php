...
<header class="main-header">
    ...
    <a href="{{ route('dashboard') }}" class="logo">
        ...
        <span class="logo-lg"><b>Infinite</b> Next</span>
    </a>
                ...
                @if (Auth::check())
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset("/bower_components/admin-lte/dist/img/user2-160x160.jpg",env('SSL',false)) }}" class="user-image" alt="User Image"/>
