<?php
$page_title = trans('users/general.page.create.title');
$page_description = trans('users/general.page.create.description');
?>
    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class="box-body">
                ...
                {!! Form::open( ['route' => 'users.store', 'id' => 'form_edit_user'] ) !!}
